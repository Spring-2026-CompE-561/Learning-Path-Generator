    ...
    if (pathname === '/'){
        ...
        return (
            <header className="relative z-10 w-full h-fit text-gray-900 dark:text-white">
                <div className="w-full h-fit flex items-center justify-between p-10 flex-col sm:flex-row" >
                    {/*
            ...
            <header className="relative z-10 w-full bg-transparent">
                <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-5">
                    ...
                    >
                        ...
                        <span className="text-base font-semibold text-gray-900 dark:text-gray-900">LearnPath</span>
                    </Link>
