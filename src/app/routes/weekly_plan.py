...
@api_router.post("/", response_model = WeeklyPlanResponse, status_code = status.HTTP_201_CREATED)
...
@api_router.get("/learning-path/{learning_path_id}", response_model = list[WeeklyPlanResponse])
